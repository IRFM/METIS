...
%--------------------------------------------------------------
function hout=zuiedit_data_srcfus

% si l'interface a deja ete appelee
[hform,hui] = zuiformhandle('data_srcfus') ;
if ishandle(hform)
...
col1 = {'libel','text@full','fusion source',[],''};
...
% data.source.fce.el
% ------------------
col1 = {'el'       ,'text' ,'el',10,info.data.source.fus.el,''} ;
...
% data.source.fce.ion
% -------------------
col1 = {'ion'       ,'text' ,'ion',10,info.data.source.fus.ion,''} ;
...
% data.source.fce.ne
% ------------------
col1 = {'ne'       ,'text' ,'ne',10,info.data.source.fus.ne,''} ;
...
% data.source.fce.j
% -----------------
col1 = {'j'       ,'text' ,'j',10,info.data.source.fus.j,''} ;
...
% data.source.fce.w
% -----------------
col1 = {'w'       ,'text' ,'w',10,info.data.source.fus.w,''} ;
...
% data.source.fce.wb
% -----------------
col1 = {'wb'       ,'text' ,'wb',10,info.data.source.fus.wb,''} ;
...
% data.source.fce.q
% -----------------
col1 = {'q'       ,'text' ,'q',10,info.data.source.fus.q,''} ;
...
% ---------------------
col1 = {'fluce'       ,'text' ,'fluce',10,info.data.source.fus.fluce,''} ;
...
% -----------------------
col1 = {'flucion'       ,'text' ,'flucion',10,info.data.source.fus.flucion,''} ;
...
% ----------------------
col1 = {'psupra'       ,'text' ,'psupra',10,info.data.source.fus.psupra,''} ;
...
% ----------------------
col1 = {'paniso'       ,'text' ,'paniso',10,info.data.source.fus.paniso,''} ;
...
% Formulaire
% ----------
hout=zuicreeform('Edition','data_srcfus','zuiedit_data_srcfus_fct','',form,comm) ;
