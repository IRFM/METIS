...
%--------------------------------------------------------------
function hout=zuiedit_data_cons_chauf_hyb

% si l'interface a deja ete appelee
[hout,hui] = zuiformhandle('data_cons_chauf_hyb') ;
if ishandle(hout)
        zuiformvisible(hout) ;
	return
end
...
% Formulaire
% ----------
hout=zuicreeform('Edition','data_cons_chauf_hyb','zuiedit_data_cons_chauf_hyb_fct','',form,comm) ;
