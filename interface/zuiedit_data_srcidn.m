% ZUIEDIT_DATA_SRCIDN formulaire d'�ition des profils source-IDN
%------------------------------------------------------------------
% fichier zuiedit_data_srcidn.m ->  
%	       zuicreeform : creation du formulaire
% 
% fonction Matlab 5 :
%	creation du formulaire d'edition des profils source-IDN
%
% syntaxe  :
...
%
%--------------------------------------------------------------
function hout=zuiedit_data_srcidn

% si l'interface a deja ete appelee
[hform,hui] = zuiformhandle('data_srcidn') ;
if ishandle(hform)
...
col1 = {'libel','text@full','nbi source',[],''};
...
% data.source.idn.el
% ------------------
col1 = {'el'       ,'text' ,'el',10,info.data.source.idn.el,''} ;
...
% data.source.idn.ion
% -------------------
col1 = {'ion'       ,'text' ,'ion',10,info.data.source.idn.ion,''} ;
...
% data.source.idn.ne
% ------------------
col1 = {'ne'       ,'text' ,'ne',10,info.data.source.idn.ne,''} ;
...
% data.source.idn.j
% ------------------
col1 = {'j'       ,'text' ,'j',10,info.data.source.idn.j,''} ;
...
% data.source.idn.w
% -----------------
col1 = {'w'       ,'text' ,'w',10,info.data.source.idn.w,''} ;
...
% data.source.idn.wb
% -----------------
col1 = {'wb'       ,'text' ,'wb',10,info.data.source.idn.wb,''} ;
...
% data.source.idn.q
% -----------------
col1 = {'q'       ,'text' ,'q',10,info.data.source.idn.q,''} ;
...
% data.source.idn.fluce
% ---------------------
col1 = {'fluce'       ,'text' ,'fluce',10,info.data.source.idn.fluce,''} ;
...
% data.source.idn.flucion
% -----------------------
col1 = {'flucion'       ,'text' ,'flucion',10,info.data.source.idn.flucion,''} ;
...
% data.source.idn.psupra
% ----------------------
col1 = {'psupra'       ,'text' ,'psupra',10,info.data.source.idn.psupra,''} ;
...
% data.source.idn.paniso
% ----------------------
col1 = {'paniso'       ,'text' ,'paniso',10,info.data.source.idn.paniso,''} ;
...
% Formulaire
% ----------
hout=zuicreeform('Edition','data_srcidn','zuiedit_data_srcidn_fct','',form,comm) ;
