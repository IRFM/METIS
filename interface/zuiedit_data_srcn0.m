% ZUIEDIT_DATA_SRCN0 formulaire d'�ition des profils source-N0
%------------------------------------------------------------------
% fichier zuiedit_data_srcn0.m ->  
%	zuicreeform : creation du formulaire
% 
% fonction Matlab 5 :
%	creation du formulaire d'�ition des profils source-N0
%
% syntaxe  :
...
%--------------------------------------------------------------
function hout=zuiedit_data_srcn0

% si l'interface a deja ete appelee
[hform,hui] = zuiformhandle('data_srcn0') ;
if ishandle(hform)
...
col1 = {'libel','text@full','source N0',[],''};
...
% data.source.n0.el
% ------------------
col1 = {'el'       ,'text' ,'el',10,info.data.source.n0.el,''} ;
...
% data.source.n0.ion
% -------------------
col1 = {'ion'       ,'text' ,'ion',10,info.data.source.n0.ion,''} ;
col2 = {'edit_ion'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_ion','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_ion','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.ne
% ------------------
col1 = {'ne'       ,'text' ,'ne',10,info.data.source.n0.ne,''} ;
col2 = {'edit_ne'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_ne','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_ne','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.j
% ------------------
col1 = {'j'       ,'text' ,'j',10,info.data.source.n0.j,''} ;
col2 = {'edit_j'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_j','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_j','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.w
% -----------------
col1 = {'w'       ,'text' ,'w',10,info.data.source.n0.w,''} ;
col2 = {'edit_w'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_w','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_w','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.wb
% -----------------
col1 = {'wb'       ,'text' ,'wb',10,info.data.source.n0.wb,''} ;
col2 = {'edit_wb'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_wb','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_wb','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.q
% -----------------
col1 = {'q'       ,'text' ,'q',10,info.data.source.n0.q,''} ;
col2 = {'edit_q'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_q','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_q','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.fluce
% ---------------------
col1 = {'fluce'       ,'text' ,'fluce',10,info.data.source.n0.fluce,''} ;
col2 = {'edit_fluce'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_fluce','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_fluce','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.flucion
% -----------------------
col1 = {'flucion'       ,'text' ,'flucion',10,info.data.source.n0.flucion,''} ;
col2 = {'edit_flucion'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_flucion','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_flucion','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.psupra
% ----------------------
col1 = {'psupra'       ,'text' ,'psupra',10,info.data.source.n0.psupra,''} ;
col2 = {'edit_psupra'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_psupra','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_psupra','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;

% data.source.n0.paniso
% ----------------------
col1 = {'paniso'       ,'text' ,'paniso',10,info.data.source.n0.paniso,''} ;
col2 = {'edit_paniso'  ,'radio','edit',0,'edit the profile',[],''} ;
col3 = {'import_paniso','radio','load',0,'load the profile',[],''} ;
col4 = {'dessin_paniso','radio','modify',0,'Redessiner le profil',[],''} ;
form{length(form)+1} = {col1,col2,col3,col4} ;
...
% Formulaire
% ----------
hout=zuicreeform('Edition','data_srcn0','zuiedit_data_srcn0_fct','',form,comm) ;
