% ZUIEDIT_DATA_SRCEXT formulaire d'�ition des profils source-EXT
%------------------------------------------------------------------
% fichier zuiedit_data_srcext.m ->  
%         zuicreeform : creation du formulaire
% 
% fonction Matlab 5 :
%	creation du formulaire d'edition des profils source-EXT
%
% syntaxe  :
...
%--------------------------------------------------------------
function hout=zuiedit_data_srcext

% si l'interface a deja ete appelee
[hform,hui] = zuiformhandle('data_srcext') ;
if ishandle(hform)
...
col1 = {'libel','text@full','External source',[],''};
...
% data.source.ext.el
% ------------------
col1 = {'el'       ,'text' ,'el',10,info.data.source.ext.el,''} ;
...
% data.source.ext.ion
% -------------------
col1 = {'ion'       ,'text' ,'ion',10,info.data.source.ext.ion,''} ;
...
% data.source.ext.ne
% ------------------
col1 = {'ne'       ,'text' ,'ne',10,info.data.source.ext.ne,''} ;
...
% data.source.ext.j
% -----------------
col1 = {'j'       ,'text' ,'j',10,info.data.source.ext.j,''} ;
...
% data.source.ext.w
% -----------------
col1 = {'w'       ,'text' ,'w',10,info.data.source.ext.w,''} ;
...
% data.source.ext.wb
% -----------------
col1 = {'wb'       ,'text' ,'wb',10,info.data.source.ext.wb,''} ;
...
% data.source.ext.q
% -----------------
col1 = {'q'       ,'text' ,'q',10,info.data.source.ext.q,''} ;
...
% data.source.ext.fluce
% ---------------------
col1 = {'fluce'       ,'text' ,'fluce',10,info.data.source.ext.fluce,''} ;
...
% data.source.ext.flucion
% -----------------------
col1 = {'flucion'       ,'text' ,'flucion',10,info.data.source.ext.flucion,''} ;
...
% data.source.ext.psupra
% ----------------------
col1 = {'psupra'       ,'text' ,'psupra',10,info.data.source.ext.psupra,''} ;
...
% data.source.ext.paniso
% ----------------------
col1 = {'paniso'       ,'text' ,'paniso',10,info.data.source.ext.paniso,''} ;
...
% Formulaire
% ----------
hout=zuicreeform('Edition','data_srcext','zuiedit_data_srcext_fct','',form,comm) ;
