...
function zuiedit_mhdyna

% si l'interface a deja ete appele
[hform,hui] = zuiformhandle('ed_mhdyna');
...
col1 = {'mhdcalc' ,'radio','calculation mode',0,'',[],''} ;
form{length(form)+1} = {col1};


col1 = {'mhdyna' ,'radio','MHD (data.cons.stab)',0, ...
...
hout=zuicreeform('Edition','ed_mhdyna','zuiedit_mhdyna_fct','',form,comm);
