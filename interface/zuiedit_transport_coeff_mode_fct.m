%  ZUIEDIT_TRANSPORT_COEFF_MODE_FCT  courte description  
%------------------------------------------------------------------------------- 
% fichier :  zuiedit_transport_coeff_mode_fct.m  ->  zuiedit_transport_coeff_mode_fct ,  ;, ;, ;, ;, ;, ; 
% 
% 
% fonction Matlab 5 : 
% 
...
%  
% syntaxe :  
%   function   zuiedit_transport_coeff_mode_fct(action) 
%  
% entrees :  
%  action = 
%  
...
[hfig,h] = zuiformhandle('ed_transport_coeff_mode') ;
