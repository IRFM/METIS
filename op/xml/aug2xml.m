% get all the data together to define ASDEX-UG

clear all;clf
addpath /home/dokuka/STRUCT_JO
addpath /home/dokuka/STRUCT_JO/asdex
...
name_koor='asdex/koor_asdex';
[rpf,zpf,drpf,dzpf,turns_num,name,kpf,SNo,ddR,ddZ]=coor_asdex(name_koor) ; 

for i=1:length(tokamak.coils.r)
  dina.pfcoils.coil{i}.name=['Coil' iii(i)];
  dina.pfcoils.coil{i}.id=i;
  dina.pfcoils.coil{i}.type='contour'; 
  dina.pfcoils.coil{i}.res=0;
  dina.pfcoils.coil{i}.turns = tokamak.coils.nt(i);
  contour = [rpf(i)+[0 drpf(i) drpf(i)+ddR(i) ddR(i) 0];...
           zpf(i)+[0 0 dzpf(i) dzpf(i) 0]];
  dina.pfcoils.coil{i}.contour=standardvec(contour);
end
