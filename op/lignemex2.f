...
c--------------------------------------------------------------
C Compilation : !fmex lignemex2.f -lnag 
C--------------------------------------------------------------
...
C pointeur 1
        ...
        call mxCopyPtrtoReal8(geom_pr,rgeom,9)     
        F       = 10*DEGRAD
        R0      = rgeom(1)
        A       = rgeom(2)
        WIP     = rgeom(3)
...
C 
         ...
         plhs(1)   = mxCreateFull(1,nr,0)
         psor1_pr  = mxGetPr(plhs(1))
         call mxCopyReal8ToPtr(Rsor,psor1_pr,nR)  

         plhs(2)   = mxCreateFull(1,nr,0)
         psor2_pr  = mxGetPr(plhs(2))
         call mxCopyReal8ToPtr(Zsor,psor2_pr,nR)  
         
         plhs(3)   = mxCreateFull(1,nr,0)
         psor3_pr  = mxGetPr(plhs(3))
         call mxCopyReal8ToPtr(Psor,psor3_pr,nR)  
c---
