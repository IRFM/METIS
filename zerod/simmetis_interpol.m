% SIMMETIS_INTEROL is an interface betwen Simulink and METIS using precomputed METIS data set(s-function)
%------------------------------------------------------------------------------------------------------------
% fichier simmetis_interpol.m ->  simmetis_interpol, mdlInitializeSizes,mdlDerivatives,
...
% function Matlab 7 :
%
% This fonction is a s-function for simulink and
% do not be use directely in matlab. Simmetis is
% an interface betwen Simulink and METIS.
% The function use a precomputed  METIS data set and 
% interpolate it to provide data as will be done by simmetis 
% that used zerodevolution.
%
...
% syntaxe  :
%
%     [sys,x0,str,ts] = simmetis_interpol(t,x,u,flag,metis_file,list_output,save_file,verbose,input_option,z0dstruct_init);
%
% entrees :
%
...
%-------------------------------------------------------------------------
%
function [sys,x0,str,ts] = simmetis_interpol(t,x,u,flag,metis_file,list_output,save_file,verbose,input_option,z0dstruct_init)
...
try
	...
	[zs,profli,z0dstruct] = zerod_interpol(z0dstruct,z0dinput.option,time,cons1t,geo1t,[],sepa1t);
        assignin('base','zerod_simmetis',zs);
        assignin('base','profil0d_simmetis',profli);
	...
	[zs,profli,z0dstruct] = zerod_interpol(z0dstruct,z0dinput.option,time,cons1t,geo1t);
        assignin('base','zerod_simmetis',zs);
        assignin('base','profil0d_simmetis',profli);
        assignin('base','cons_simmetis',cons1t);
        assignin('base','geo_simmetis',geo1t);
