...
%  1 -> ts
%  2 -> JET
%  -1 -> pas de donnees pour la comparaison
if nargin < 1
	mode_exp = 0;
end
if nargin < 2
...
case 1
	...
	% 1 - numero du choc
	   ...
	   try 
   	   ...
   	   otherwise
      		   prompt={'shot number :','charge of main gaz :' };
      		   def={sprintf('%d',numshot),'1'};
	...
	% 1 - numero du choc
        if isempty(shot) |isempty(gaz)
   	   ...
   	   case 'francais'
      		   prompt={'Numero du choc :','Charge du gaz principal :'};
      		   def={'58454','1'};
      		   dlgTitle='Lecture des donnees de JET';
   	   otherwise
      		   prompt={'shot number :','charge of main gaz :' };
      		   def={'58454','1'};
      		   dlgTitle='Access to JET Datas';
    	   end
   	   lineNo=1;
   	   answer=zinputdlg(prompt,dlgTitle,lineNo,def);
   	   if isempty(answer)
...
%  	liste{end+1} = 'ppf/@shot/NBI8/AL8';
	...
	liste{end+1}   = 'ppf/@shot/NBIP/YPNS';    % neutron du au plasma (thermique)
...
apol = medfilt1(acos((rabs - (r0 + d)) ./ rho) / pi .* 180,3);
