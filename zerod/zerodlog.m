...
%[post.zerod,void,post.profil0d] = zerodlog(z0dinput.option,z0dinput.cons,z0dinput.geo,z0dinput.exp0d,[],1001);post.z0dinput = z0dinput;z0plotsc;
function [zs,info,profli]= zerodlog(option,cons,geo,exp0d,thyb,nbte)
...
times   = cons.temps;
temps =  logspace(log10(min(times)),log10(max(times)),nbte)';
