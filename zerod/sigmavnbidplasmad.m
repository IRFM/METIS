...
% boucle sur les temperature plasma
   for l=1:length(eti)
      ...
      svcb          = trapz(v,svb2int(v,vth,vb,1));
      %warning off
      ...
      svnbidd(k,l)  = svcb;
      fprintf(' svnbidd(%g,%g) = %g  @ %g   (m^3*s)\n',vb,vth,svcb,svcb);
   end
end
save sigmav_nbi_d_plasma_d enbi eti svnbidd
