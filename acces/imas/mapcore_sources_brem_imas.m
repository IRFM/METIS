...
function coresource = mapcore_sources_brem_imas(z0dstruct,data_zerod,profil0d,texte_diary,error_flag,sigma_B0_eff,coresource)

%% IDENTIFIER of the source
coresource.identifier.name  = 'bremsstrahlung';
coresource.identifier.index = 8;
coresource.identifier.description='Bremsstrahlung radiation source of power from METIS model';
% null profile
...
for k=1:length(profil0d.temps)
	...
	profiles_1d.electrons.energy             = - profil0d.pbrem(k,:);
