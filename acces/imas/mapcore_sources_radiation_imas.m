...
function coresource = mapcore_sources_radiation_imas(z0dstruct,data_zerod,profil0d,texte_diary,error_flag,sigma_B0_eff,coresource)

%% IDENTIFIER of the source
coresource.identifier.name  = 'line_radiation';
coresource.identifier.index = 10;
coresource.identifier.description='Line radiation source of power from METIS model';
% null profile
...
for k=1:length(profil0d.temps)
	...
	profiles_1d.electrons.energy             = - profil0d.prad(k,:);
