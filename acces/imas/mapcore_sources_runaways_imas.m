...
function coresource = mapcore_sources_runaways_imas(z0dstruct,data_zerod,profil0d,texte_diary,error_flag,sigma_B0_eff,coresource)

%% IDENTIFIER of the source
coresource.identifier.name  = 'runaways';
coresource.identifier.index = 501;
coresource.identifier.description='Runaway electrons source source of currentfrom METIS model';
% null profile
...
for k=1:length(profil0d.temps)
	...
	profiles_1d.electrons.energy             = zz;
        ...
        profiles_1d.j_parallel                   = profil0d.jrun(k,:);
