...
for k=1:max(length(ref.boundary.x_point),length(chease.boundary.x_point))
  ...
  if k <= length(chease.boundary.x_point)
    if length(chease.boundary.x_point) > 1
      fprintf('CHEASE x_point @ (%g,%g)',chease.boundary.x_point{k}.r,chease.boundary.x_point{k}.z);  
   
    elseif (length(chease.boundary.x_point) == k) && isfield(chease.boundary.x_point,'r')
      fprintf('CHEASE x_point @ (%g,%g) &',chease.boundary.x_point.r,chease.boundary.x_point.z);
    end
  end
  fprintf('\n');
end
...
title('Boundary : blue = METIS & red = CHEASE');
xlabel('R')
ylabel('Z')
legend('METIS','CHEASE');
...
%axis('equal');
title('PSI: blue = METIS & red = CHEASE');
xlabel('R (m)');
ylabel('Z (m)');
...
%axis('equal');
title('PHI: blue = METIS & red = CHEASE');
xlabel('R (m)');
ylabel('Z (m)');
...
%axis('equal');
title('j_tor: blue = METIS & red = CHEASE');
xlabel('R (m)');
ylabel('Z (m)');
...
%axis('equal');
title('j_parallel: blue = METIS & red = CHEASE');
xlabel('R (m)');
ylabel('Z (m)');
...
%axis('equal');
title('Br: blue = METIS & red = CHEASE');
xlabel('R (m)');
ylabel('Z (m)');
...
%axis('equal');
title('Bz: blue = METIS & red = CHEASE');
xlabel('R (m)');
ylabel('Z (m)');
...
%axis('equal');
title('Btor: blue = METIS & red = CHEASE');
xlabel('R (m)');
ylabel('Z (m)');
...
title('Bpoloidal: blue = METIS & red = CHEASE');
xlabel('R (m)');
ylabel('Z (m)');
