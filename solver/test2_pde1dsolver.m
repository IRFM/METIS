...
if nargin ==0
	...
	t0=input('la derivee de la temperature en x=0 ? ');
	t1=input('la derivee de la temperature en x=1 ? ');
...
T1=T0;
% condition en x=0
T0(:,1,2)=ones(2,1);         % condition sur la derivee de   T
V0(:,1) = t0 .* ones(2,1);   % valeur de T au bord 

% condition en x=0
T1(:,1,2)=ones(2,1);         % condition sur la derivee de T
