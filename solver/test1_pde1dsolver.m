...
T1=T0;
% condition en x=0
T0(:,1,1)=ones(2,1);         % condition sur la valeur pour T
V0(:,1) = t0 .* ones(2,1);   % valeur de T au bord 

% condition en x=0
T1(:,1,1)=ones(2,1);         % condition sur la valeur pour T
